...
public class QueryEngineLogTest
{
	private MVStoreManager manager;
	private QueryEngineLog log;
	...
	public void beforeEach()
	{
		...
		log = new QueryEngineLog(manager, "log");
	}
	...
	public void testAppendDelete()
	{
		...
		Iterator<LongObjectPair<QueryEngineLog.Entry>> it = log.iterator(0);
		LongObjectPair<QueryEngineLog.Entry> e = it.next();

		assertThat(e.getTwo().getType(), is(QueryEngineLog.EntryType.DELETION));
	...
	public void testAppendStore()
	{
		...
		assertThat(e.getTwo().getType(), is(QueryEngineLog.EntryType.STORE));
		assertThat(e.getTwo().getId(), is(1l));
