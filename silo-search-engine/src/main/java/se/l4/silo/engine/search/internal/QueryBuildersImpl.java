...
import se.l4.silo.engine.search.query.AndQueryBuilder;
import se.l4.silo.engine.search.query.FieldQueryBuilder;
import se.l4.silo.engine.search.query.OrQueryBuilder;
