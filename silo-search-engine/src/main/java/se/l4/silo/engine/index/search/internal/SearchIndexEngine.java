 ...
 */
public class SearchIndexEngine<T>
	implements IndexEngine<T, SearchIndexQuery<T, ?>>
{
	private static final Logger log = LoggerFactory.getLogger(SearchIndexEngine.class);
